 ...
 */
$config['site_title']           = "Systema"; 		// Site Title, example.com
$config['admin_email']          = "cub4lt@gmail.com"; 	// Admin Email, admin@example.com
$config['default_group']        = 'main'; 			// Default group, use name
