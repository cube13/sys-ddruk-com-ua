...
<div class="row">
    ...
    <div class="span5">
        ...
        switch ($order->paymethod) {
            case 'nal':
                $nala = 'btn-info';
                $printInvoiceText='Чек';
                break;
            case 'bnlfop':
                $bnlfopa = 'btn-info';
                $printInvoiceText='Рахунок-фактура';
                break;
            case 'bnltov':
                $bnltova = 'btn-info';
                $printInvoiceText='Рахунок-фактура';
            ...
            case 'bnltovfsu':
                ...
                break;
            case 'subscr':
                $printInvoiceText='Акт використання абонементу';
                $subscr = 'btn-info';
                break;
        } ?>
        ...
        <div class="btn-group">
            ...
            <?php if ($order->org_id != 11): ?>
                ...
                <a href="/orders/set_paymethod/<?php echo $order->id; ?>/bnltov"
                   class="btn <?php echo $bnltova; ?>">Добрий Друк</a>
                <a href="/orders/set_paymethod/<?php echo $order->id; ?>/bnltovitfs"
                   class="btn <?php echo $bnltovitfsa; ?>">ITFS</a>
                <a href="/orders/set_paymethod/<?php echo $order->id; ?>/bnltovfsu"
                   class="btn <?php echo $bnltovfsua; ?>">ФСУ</a>
            <?php endif; ?>
...
<div class="row">
    ...
    <div class="span1 ">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                ...
                <li><?php echo anchor_popup('/fin/print_check/' . $order->id.'/'.$order->paymethod, $printInvoiceText, $atts_order); ?></li>
                <?php if($order->paymethod=='bnlfop' || $order->paymethod=='bnltov'):?>
                    <li><?php echo anchor_popup('/fin/print_check/' . $order->id.'/actofwork', 'Акт виконаних робіт', $atts_order); ?></li>
                <?php endif;?>
    ...
    <div>
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation">
                <?php $cart_all = $this->cartridge->get_stage_simple('inofc', 1, $order->id)->row()->count; ?>
                <?php $cart_done = $this->cartridge->get_stage_simple('inrfl', 1, $order->id)->row()->count; ?>
                <a href="#cart_tab" aria-controls="cart_tab" role="tab" data-toggle="tab">Картриджі <span class="badge badge-info"><?php echo $cart_done;?>/<?php echo $cart_all;?></span></a>
            </li>
            <li role="presentation">
                            ...
                            <tr>
                                <td colspan="2">
                                    <form action="/messages/add/<?php echo $order->id; ?>/<?php echo $order->id; ?>/info" method="post"
                                          accept-charset="utf-8">
                                        <div class="input-prepend input-append">
                                            <select class="span2" name="code">
                                                <option value="contact-mob">Моб.тел.</option>
                                            </select>
                                            <input class="span2" value="" size="12" type="text" name="text" id="mobphone">
                                        </div>
                                    </form>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php foreach ($managers as $id => $name):?>
                                        <li><a href="/orders/setowner/<?php echo $order_id;?>/<?php echo $id;?>"><?php echo $name;?></a></li>
                                    <?php endforeach;?>
                                        </ul>
                                    </div>
                                    <?php else:?>
